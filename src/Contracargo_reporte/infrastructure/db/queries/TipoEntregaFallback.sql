...
JOIN LATERAL (
    ...
    ORDER BY id_orders_deliveries ASC
    LIMIT 1
) t2_top ON TRUE
JOIN main.t_users_addresses_books t3 ON t2_top.id_users_addresses_books = t3.id_users_addresses_books
JOIN main.t_users_addresses t4 ON t3.id_users_addresses = t4.id_users_addresses
